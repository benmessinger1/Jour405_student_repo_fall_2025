...
GDP |> 
  ...
  labs(
  title = "Correlation between GDP and DJIA",
  y = "DJIA",
  x = "GDP"
)
...
There is a strong correlation between DJIA and GDP, that is why there is a slope that svenly splits between different dots on the scatterplot. The scatterplot shows a slope that is in between the different samples of correlation between GDP and DJIA, which show that there is a strong correlation between the two. 

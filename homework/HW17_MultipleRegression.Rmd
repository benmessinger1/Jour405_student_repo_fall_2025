...
The cities with the higher percentage of white people typically have a higher voter turnout, that seems like there is a correlation between those two variables. Also cities with a lower percentage of unemployed people typically have a higher voter turnout, that seems like there is a correlation between those two variables. I don't think there's much correlation between the median age and turnout and lower populations can have a higher voter turnout but also may not.
...
ANSWER HERE
This multiple variable model predict turns out pretty good, It shows that cities with a high percentage of white people, low percentage of unemployed and low populations have a high voter turnout. Income, median age and bachelors seem pretty insignificant, they have scatterplots that are pretty varied and there isn't a high correlation at the top or bottom of the graphs. The Adjusted R-squared is 0.8023 which means there's there's a bunch of variation in turnout as the p-value of being 2.999e-06 shows that it is highly significant with Income, median age, and being white, but significantly with edication, unemployment and population. 
...
Yes, the percentange of unemployed people was much more significant when any other independent variables and the least significant model was population. By comparing those models the percentage of unemployed people directly correlated with voter turnout, and was significantly better than the others.
ANSWER HERE
...
I can use this analysis to cover an election or voter participation story to see what variables can be best looked at in terms of finding out what variables are most important in viewing a place or state or city when looking at a poll on who votes in what cities and the amount of people who vote in different places.

...
The mean amount of thefts before the spike where low at 216.9014 and the mean rate was 23.19204 and the standard deviation was 5.667551. In the spike year, the mean of the amount of thefts increased by over 356.5153 an the rate increased by 36.75536, the standard deviation increased by 1.29 and the median increased by 35.95184. After the spike, tefts decreased, but were still much higher than before the strike and that was the same for the mean rate and median. The Standard deviation increased even more to 7.722196. This suggests that the spike showed an explosion in amount of thefts and it decreased after the spike, but not close to the rate it was before the spoke.
...
From 2017 to 2022, the amount of car thefts stayed relatively constant and then started to increase in 2023 and spiked, before decreasing afterward.

Monthy car thefts spikes in 2024 after remaining constant since 2018
...
- **Null Hypothesis (H0)**:  The mean theft rate after the spike will be closer to during the spike than before the spike

- **Alternative Hypothesis (H1)**: The mean theft rate after the spike will be closer to before the spike than during the spike
...
Because the time periods have a significance level of 2e-16, which is a lot less than the F value of 218, there are real differences in the average rates because of the amount the mean rate changed between before, during and after the spike the resilts are very statistically significant. At a 95% confidence level, the 2e-16 is less than 0.05, therefore it is statistically significant and because one of the values show that the ratio of two variances is significant, the differences in the average rates and results are also significant.
...
THe Tukey's test shows that there's definitly a significant difference between pre-spike and the spike year, as well as pre-spoke and post-spike the confidence interval between the spike-year and post-spike are above the confidence interval of pre-spike. That said, the post-strike confidence interval is slightly above the lower end of the spike year, making it not enough of a significant difference between those two periods. But, the difference between the pre-spike and post-spike periods are real and significant.

Car theft rates after the spike are significantly greater than before the spike.

In 2023, car theft rates exponentially spiked after remaining constant for the six years prior. After the spike, car thefts significantly increased from the rate before the spike. 

...
Education levels in survey samples often differ from the general population because people who respond to surveys may be more inclined to respond to surveys. Factors of over or under representation include the way the survey contacts people and demoraphics that are more likely to have people respond to a survey.
...
College educated Americans are most likely to vote compared to those with less levels of education.
...
College education students stayed mostly the same and the Yes percentage canged by 0.06 and the no's and unsure changed by 0.1. High school or less changed by two to three percentage points for each one -- it was the biggest change, some college education didn't change by much. 


2. Why might the weighted results be considered more accurate than the unweighted results?

Weigthed results may be considered more accurate than the unweighted results because it accurately changed the amount of non college educated voters who replied to the survey compred to others who didn't.
...
It is important for journalists to understand survey weighting when reporting on polls because you don't want to anticipate a certain result in an election, just for it to be wrong because you underweighted or didn't consider weighting from different groups.


2. How might the differences between weighted and unweighted results affect how you would report on this data?

The differences between weighted and unweighted results affect how you would report on this data would make me focus especially on the high school or less education level and make sure that that group of people are accurately represented in the election.
...
I would like to know how election data and weighting data are similar and different from unweighted data and the actual results of the elections. 

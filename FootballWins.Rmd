...
I would definitely think that this is a useful model because there are multiple factors put together that will correlate to a team winning a game. Points scored is the most important factor in terms of wins, then takeaways and lastly yards gained. This is significant because the p-value is significant at the 0.01 variable at 4.058e-06. Yards gained is not significant, but points scored and takeaways are significant in causing a team to win games. It's a useful model to show me, the general factors as to which a football team wins games -- in a statistic measure rather than guessing.
...
The bigger the circle, the larger the correlation. In terms of the graph, points scored has the greatest correlation to wins, but yardage gained and points scored have an even greater correlation with yards gained. But yards gained and wins have a low correlation. Using the NY Jets as an example, they scored the second-least points at 276 and only had seven wins, which isn't one of lowest but on the lower end. Where if you take the Ravens as an example, the scored the most points and thus had the most wins. 

## Using the Model

Without using the words "multiple regression model", describe how you could use this model to cover a team or game.

In winning a football game, using yards gained, points scored and takeaways, metrics can make the amount of points scored have a strong correlation with the amount of wins the teams get.

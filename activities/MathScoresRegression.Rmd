...
The highest FARMS percentages have math scores between 57.6 and 77.8, but those percentages are all 100%. The highest Math score is 95.7 and has a FARM percentage at 40.5680. But all the math scores above 80 are between FARM percentages of 19.6388 and 48.0916. Not many schools are located along the line of best fit, therefore the FARM percentage does have much impact on the math test scores.
...
The adusted R-Squared value is 0.0254 and not very close to 100, while the p-value is higher at 0.1225, therefore less of the outcome the independent variable is explained. The nature of the relationship between FARMS percentage and math scores is not very significant becaue the adjusted R-squared value and p-value is both less than FARMS coefficient.
...
Whitemarsh Elementary School had the largest difference of the prediction of 60.99729 and it came in at 34.8972916, which was a residual of -34.8972916. Gulph Elementary School was also a large difference with a residual of -31.3432381. The predicted and Math scores the most similar will have a resudual closer to 0, which is a more accurate representation. 
...
The conslusions that I drew from this model's results is to say that it was not significantly significant to prove that elementary schools with fewer students on free and reduced price meals do better on standardized math tests because the p-value was not significant, as well as the adjusted r-squared value. 

The story pitch I would have is to find out what is the biggest influence on high math test scores.

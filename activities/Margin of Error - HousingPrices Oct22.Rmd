...
Sample size is 100: MoE - 10
sample size is 800: MoE - 3.536
Sample size is 400: MoE - 5
...
Technically no it's not completely statistically justified, because 52% in the sample of 100 with a margin of error of 10 can be as high as 62% and as low as 42%. The sample of 800 can be as low as just under 50% and as high as over 56%. The sample of 400 can be as low as 50% and as high as 60%.

The Majority Tentatively Supports New City Policy prior to Margin of Error
...
Evidence suggests that the after the installation of new transit line in the Washington D.C. area has averagehome values have increased in the surrounding area. Based on the data, the average value of housing prices increased by $19.5K on a 6.8% percentage change which proves that the data is statistically significant. The average increased from $285K to $304.5K since the new transit line was added. 
